...
class ActivityApi(object):
    ...
    def post_v5_notifications_messages(self, username, content, **kwargs):  # noqa: E501
        """发送私信给指定用户  # noqa: E501

        发送私信给指定用户  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_v5_notifications_messages(username, content, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str username: 用户名(username/login) (required)
        :param str content: 私信内容 (required)
        :param str access_token: 用户授权码
        :return: UserMessage
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_v5_notifications_messages_with_http_info(username, content, **kwargs)  # noqa: E501
        else:
            (data) = self.post_v5_notifications_messages_with_http_info(username, content, **kwargs)  # noqa: E501
            return data

    def post_v5_notifications_messages_with_http_info(self, username, content, **kwargs):  # noqa: E501
        """发送私信给指定用户  # noqa: E501

        发送私信给指定用户  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_v5_notifications_messages_with_http_info(username, content, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['username', 'content', 'access_token']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def put_v5_user_subscriptions_owner_repo(self, owner, repo, watch_type, **kwargs):  # noqa: E501
        """watch 一个仓库  # noqa: E501

        watch 一个仓库  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_v5_user_subscriptions_owner_repo(owner, repo, watch_type, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str owner: 仓库所属空间地址(企业、组织或个人的地址path) (required)
        :param str repo: 仓库路径(path) (required)
        :param str watch_type: watch策略, watching: 关注所有动态, releases_only: 仅关注版本发行动态, ignoring: 关注但不提醒动态 (required)
        :param str access_token: 用户授权码
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_v5_user_subscriptions_owner_repo_with_http_info(owner, repo, watch_type, **kwargs)  # noqa: E501
        else:
            (data) = self.put_v5_user_subscriptions_owner_repo_with_http_info(owner, repo, watch_type, **kwargs)  # noqa: E501
            return data

    def put_v5_user_subscriptions_owner_repo_with_http_info(self, owner, repo, watch_type, **kwargs):  # noqa: E501
        """watch 一个仓库  # noqa: E501

        watch 一个仓库  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_v5_user_subscriptions_owner_repo_with_http_info(owner, repo, watch_type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['owner', 'repo', 'watch_type', 'access_token']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('watch_type' not in params or
                                                       params['watch_type'] is None):  # noqa: E501
