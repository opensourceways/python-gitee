...
class MiscellaneousApi(object):
    ...
    def get_v5_licenses_license_with_http_info(self, license, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('license' not in params or
                                                       params['license'] is None):  # noqa: E501
    ...
    def post_v5_markdown(self, text, **kwargs):  # noqa: E501
        """渲染 Markdown 文本  # noqa: E501

        渲染 Markdown 文本  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_v5_markdown(text, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str text: Markdown 文本 (required)
        :param str access_token: 用户授权码
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_v5_markdown_with_http_info(text, **kwargs)  # noqa: E501
        else:
            (data) = self.post_v5_markdown_with_http_info(text, **kwargs)  # noqa: E501
            return data

    def post_v5_markdown_with_http_info(self, text, **kwargs):  # noqa: E501
        """渲染 Markdown 文本  # noqa: E501

        渲染 Markdown 文本  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_v5_markdown_with_http_info(text, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['text', 'access_token']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
