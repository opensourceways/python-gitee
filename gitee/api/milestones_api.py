...
class MilestonesApi(object):
    ...
    def patch_v5_repos_owner_repo_milestones_number(self, body, owner, repo, number, **kwargs):  # noqa: E501
        """更新仓库里程碑  # noqa: E501

        更新仓库里程碑  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_v5_repos_owner_repo_milestones_number(body, owner, repo, number, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param MilestonesNumberBody body: (required)
        :param str owner: 仓库所属空间地址(企业、组织或个人的地址path) (required)
        :param str repo: 仓库路径(path) (required)
        :param int number: 里程碑序号(id) (required)
        :return: Milestone
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_v5_repos_owner_repo_milestones_number_with_http_info(body, owner, repo, number, **kwargs)  # noqa: E501
        else:
            (data) = self.patch_v5_repos_owner_repo_milestones_number_with_http_info(body, owner, repo, number, **kwargs)  # noqa: E501
            return data

    def patch_v5_repos_owner_repo_milestones_number_with_http_info(self, body, owner, repo, number, **kwargs):  # noqa: E501
        """更新仓库里程碑  # noqa: E501

        更新仓库里程碑  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_v5_repos_owner_repo_milestones_number_with_http_info(body, owner, repo, number, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_v5_repos_owner_repo_milestones_number`")  # noqa: E501
        # verify the required parameter 'owner' is set
        if ('owner' not in params or
                params['owner'] is None):
    ...
    def patch_v5_repos_owner_repo_milestones_number(self, access_token, title, state, description, due_on, owner, repo, number, **kwargs):  # noqa: E501
        """更新仓库里程碑  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_v5_repos_owner_repo_milestones_number_with_http_info(access_token, title, state, description, due_on, owner, repo, number, **kwargs)  # noqa: E501
        else:
            (data) = self.patch_v5_repos_owner_repo_milestones_number_with_http_info(access_token, title, state, description, due_on, owner, repo, number, **kwargs)  # noqa: E501
            return data

    def patch_v5_repos_owner_repo_milestones_number_with_http_info(self, access_token, title, state, description, due_on, owner, repo, number, **kwargs):  # noqa: E501
        """更新仓库里程碑  # noqa: E501
        ...
        all_params = ['access_token', 'title', 'state', 'description', 'due_on', 'owner', 'repo', 'number']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('access_token' not in params or
            ...
            raise ValueError("Missing the required parameter `access_token` when calling `patch_v5_repos_owner_repo_milestones_number`")  # noqa: E501
        ...
        if ('state' not in params or
            ...
            raise ValueError("Missing the required parameter `state` when calling `patch_v5_repos_owner_repo_milestones_number`")  # noqa: E501
        # verify the required parameter 'description' is set
        if ('description' not in params or
                params['description'] is None):
            raise ValueError("Missing the required parameter `description` when calling `patch_v5_repos_owner_repo_milestones_number`")  # noqa: E501
    ...
    def post_v5_repos_owner_repo_milestones(self, body, owner, repo, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param RepoMilestonesBody body: (required)
        :param str owner: 仓库所属空间地址(企业、组织或个人的地址path) (required)
        :param str repo: 仓库路径(path) (required)
        :return: Milestone
                 If the method is called asynchronously,
    ...
    def post_v5_repos_owner_repo_milestones_with_http_info(self, body, owner, repo, **kwargs):  # noqa: E501
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_v5_repos_owner_repo_milestones`")  # noqa: E501
        # verify the required parameter 'owner' is set
        if ('owner' not in params or
                params['owner'] is None):
    ...
    def post_v5_repos_owner_repo_milestones(self, access_token, title, state, description, due_on, owner, repo, **kwargs):  # noqa: E501
        """创建仓库里程碑  # noqa: E501

        创建仓库里程碑  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_v5_repos_owner_repo_milestones(access_token, title, state, description, due_on, owner, repo, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_v5_repos_owner_repo_milestones_with_http_info(access_token, title, state, description, due_on, owner, repo, **kwargs)  # noqa: E501
        else:
            (data) = self.post_v5_repos_owner_repo_milestones_with_http_info(access_token, title, state, description, due_on, owner, repo, **kwargs)  # noqa: E501
            return data

    def post_v5_repos_owner_repo_milestones_with_http_info(self, access_token, title, state, description, due_on, owner, repo, **kwargs):  # noqa: E501
        """创建仓库里程碑  # noqa: E501

        创建仓库里程碑  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_v5_repos_owner_repo_milestones_with_http_info(access_token, title, state, description, due_on, owner, repo, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['access_token', 'title', 'state', 'description', 'due_on', 'owner', 'repo']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('access_token' not in params or
                params['access_token'] is None):
            raise ValueError("Missing the required parameter `access_token` when calling `post_v5_repos_owner_repo_milestones`")  # noqa: E501
        # verify the required parameter 'title' is set
        if ('title' not in params or
                params['title'] is None):
        ...
        if ('state' not in params or
                params['state'] is None):
            raise ValueError("Missing the required parameter `state` when calling `post_v5_repos_owner_repo_milestones`")  # noqa: E501
        # verify the required parameter 'description' is set
        if ('description' not in params or
                params['description'] is None):
            raise ValueError("Missing the required parameter `description` when calling `post_v5_repos_owner_repo_milestones`")  # noqa: E501
        # verify the required parameter 'due_on' is set
        if ('due_on' not in params or
                params['due_on'] is None):
