...
class WebhooksApi(object):
    ...
    def patch_v5_repos_owner_repo_hooks_id(self, owner, repo, id, url, **kwargs):  # noqa: E501
        """更新一个仓库WebHook  # noqa: E501

        更新一个仓库WebHook  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_v5_repos_owner_repo_hooks_id(owner, repo, id, url, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_v5_repos_owner_repo_hooks_id_with_http_info(owner, repo, id, url, **kwargs)  # noqa: E501
        else:
            (data) = self.patch_v5_repos_owner_repo_hooks_id_with_http_info(owner, repo, id, url, **kwargs)  # noqa: E501
            return data

    def patch_v5_repos_owner_repo_hooks_id_with_http_info(self, owner, repo, id, url, **kwargs):  # noqa: E501
        """更新一个仓库WebHook  # noqa: E501

        更新一个仓库WebHook  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_v5_repos_owner_repo_hooks_id_with_http_info(owner, repo, id, url, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['owner', 'repo', 'id', 'url', 'access_token', 'password', 'push_events', 'tag_push_events', 'issues_events', 'note_events', 'merge_requests_events']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def post_v5_repos_owner_repo_hooks(self, owner, repo, url, **kwargs):  # noqa: E501
        """创建一个仓库WebHook  # noqa: E501

        创建一个仓库WebHook  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_v5_repos_owner_repo_hooks(owner, repo, url, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_v5_repos_owner_repo_hooks_with_http_info(owner, repo, url, **kwargs)  # noqa: E501
        else:
            (data) = self.post_v5_repos_owner_repo_hooks_with_http_info(owner, repo, url, **kwargs)  # noqa: E501
            return data

    def post_v5_repos_owner_repo_hooks_with_http_info(self, owner, repo, url, **kwargs):  # noqa: E501
        """创建一个仓库WebHook  # noqa: E501

        创建一个仓库WebHook  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_v5_repos_owner_repo_hooks_with_http_info(owner, repo, url, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['owner', 'repo', 'url', 'access_token', 'password', 'push_events', 'tag_push_events', 'issues_events', 'note_events', 'merge_requests_events']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
