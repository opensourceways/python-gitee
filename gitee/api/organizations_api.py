...
class OrganizationsApi(object):
    ...
    def post_v5_users_organization(self, name, org, **kwargs):  # noqa: E501
        """创建组织  # noqa: E501

        创建组织  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_v5_users_organization(name, org, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str name: 组织名称 (required)
        :param str org: 组织的路径(path/login) (required)
        :param str access_token: 用户授权码
        :param str description: 组织描述
        :return: Group
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_v5_users_organization_with_http_info(name, org, **kwargs)  # noqa: E501
        else:
            (data) = self.post_v5_users_organization_with_http_info(name, org, **kwargs)  # noqa: E501
            return data

    def post_v5_users_organization_with_http_info(self, name, org, **kwargs):  # noqa: E501
        """创建组织  # noqa: E501

        创建组织  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_v5_users_organization_with_http_info(name, org, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['name', 'org', 'access_token', 'description']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
