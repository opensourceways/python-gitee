...
from gitee.models.program_basic import ProgramBasic  # noqa: F401,E501
...
class Issue(object):
    ...
    def __init__(self, id=None, url=None, repository_url=None, labels_url=None, comments_url=None, html_url=None, parent_url=None, number=None, state=None, title=None, body=None, body_html=None, user=None, labels=None, assignee=None, collaborators=None, repository=None, milestone=None, created_at=None, updated_at=None, plan_started_at=None, deadline=None, finished_at=None, scheduled_time=None, comments=None, issue_type=None, program=None):  # noqa: E501
