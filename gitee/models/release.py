...
class Release(object):
    ...
    def __init__(self, id=None, tag_name=None, target_commitish=None, prerelease=None, name=None, body=None, author=None, created_at=None, assets=None, _configuration=None):  # noqa: E501
