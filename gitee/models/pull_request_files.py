...
class PullRequestFiles(object):
    ...
    def __init__(self, sha=None, filename=None, status=None, additions=None, deletions=None, blob_url=None, raw_url=None, patch=None, _configuration=None):  # noqa: E501
