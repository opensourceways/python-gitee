...
class Group(object):
    ...
    def __init__(self, id=None, login=None, url=None, avatar_url=None, repos_url=None, events_url=None, members_url=None, description=None, _configuration=None):  # noqa: E501
