...
class CodeForksHistory(object):
    ...
    def __init__(self, url=None, forks_url=None, commits_url=None, id=None, description=None, public=None, owner=None, user=None, files=None, truncated=None, html_url=None, comments=None, comments_url=None, git_pull_url=None, git_push_url=None, created_at=None, updated_at=None, forks=None, history=None):  # noqa: E501
