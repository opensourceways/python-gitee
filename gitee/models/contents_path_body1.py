...
class ContentsPathBody1(object):
    ...
    def __init__(self, access_token=None, content=None, sha=None, message=None, branch=None, committer_name=None, committer_email=None, author_name=None, author_email=None):  # noqa: E501
    ...
    @property
    def sha(self):
        """Gets the sha of this ContentsPathBody1.  # noqa: E501

        文件的 Blob SHA，可通过 [获取仓库具体路径下的内容] API 获取  # noqa: E501

        :return: The sha of this ContentsPathBody1.  # noqa: E501
        :rtype: str
        """
        return self._sha
    ...
    @sha.setter
    def sha(self, sha):
        """Sets the sha of this ContentsPathBody1.

        文件的 Blob SHA，可通过 [获取仓库具体路径下的内容] API 获取  # noqa: E501

        :param sha: The sha of this ContentsPathBody1.  # noqa: E501
        :type: str
        """
        if sha is None:
