...
class RepositoryPostParam(object):
    ...
    def __init__(self, access_token=None, name=None, description=None, homepage=None, has_issues=True, has_wiki=True, can_comment=True, public=None, private=None, auto_init=None, gitignore_template=None, license_template=None):  # noqa: E501
