...
class RepoPatchParam(object):
    ...
    def __init__(self, access_token=None, name=None, description=None, homepage=None, has_issues='true', has_wiki='true', can_comment=None, private=None, path=None, default_branch=None, _configuration=None):  # noqa: E501
