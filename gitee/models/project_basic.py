...
class ProjectBasic(object):
    ...
    def __init__(self, id=None, full_name=None, human_name=None, url=None, namespace=None, path=None, name=None, owner=None, description=None, private=None, public=None, internal=None, fork=None, html_url=None, ssh_url=None):  # noqa: E501
