...
from gitee.models.namespace import Namespace  # noqa: F401,E501
...
class Project(object):
    ...
    def __init__(self, id=None, full_name=None, human_name=None, url=None, namespace=None, path=None, name=None, owner=None, description=None, private=None, public=None, internal=None, fork=None, html_url=None, ssh_url=None, forks_url=None, keys_url=None, collaborators_url=None, hooks_url=None, branches_url=None, tags_url=None, blobs_url=None, stargazers_url=None, contributors_url=None, commits_url=None, comments_url=None, issue_comment_url=None, issues_url=None, pulls_url=None, milestones_url=None, notifications_url=None, labels_url=None, releases_url=None, recommend=None, homepage=None, language=None, forks_count=None, stargazers_count=None, watchers_count=None, default_branch=None, open_issues_count=None, has_issues=None, has_wiki=None, can_comment=None, pull_requests_enabled=None, has_page=None, license=None, outsourced=None, project_creator=None, members=None, pushed_at=None, created_at=None, updated_at=None, parent=None, paas=None, stared=None, watched=None, permission=None, relation=None):  # noqa: E501
