...
class Commit(object):
    ...
    def __init__(self, id=None, tree_id=None, parent_ids=None, message=None, timestamp=None, url=None, author=None, committer=None, distinct=None, added=None, removed=None, modified=None, _configuration=None):  # noqa: E501
