...
class TestPullRequestsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = gitee.api.pull_requests_api.PullRequestsApi()  # noqa: E501
    ...
    def test_delete_v5_repos_owner_repo_pulls_label(self):
        """Test case for delete_v5_repos_owner_repo_pulls_label
